      ...
      <Section className="md:flex md:flex-col md:justify-center md:h-full">
        <div className="lg:w-8/12 xl:w-1/2">
          ...
          <p className="mt-6 mb-4 lg:text-lg">
            ...
            student the University of Wisconsin-Madison. I’m an avid JavaScript
            developer with a passion for the JAMStack, I currently work with
            Gatsby.js, Next.js, GraphQL, Netlify, Vercel, Node.js, and lambda
            functions to build high performance websites!
          </p>
